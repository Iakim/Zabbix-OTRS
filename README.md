...
Total de tempo com problema: {EVENT.AGE}" --fila "Infra" --servico "INCIDENTE::INFRAESTRUTURA::SERVIDORES::LINUX" --sla "ALTA::24" --triggerid {TRIGGER.ID} --host {HOST.NAME} --status INDISPONIBILIDADE
